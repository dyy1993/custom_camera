...
- (void)viewDidLoad {
    ...
    UIButton *backBtn = [[UIButton alloc] initWithFrame:CGRectMake(16, self.view.safeAreaInsets.top + 8, 60, 60)];
    [backBtn setTitle:@"返回" forState:UIControlStateNormal];
    [backBtn addTarget:self action:@selector(dismissVc) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:backBtn];
    self.backView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.safeAreaInsets.top + 76, kMainScreenWidth, kMainScreenHeight-200)];
    [self.view addSubview:self.backView];
    
    UIButton *takePhotoBtn = [[UIButton alloc] initWithFrame:CGRectMake(kMainScreenWidth/2 - 30, kMainScreenHeight - 100, 60, 60)];
